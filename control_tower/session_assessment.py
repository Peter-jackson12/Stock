...
lease, feed-freshness, and research-eligibility evidence into one "healthy"
...
FEED_STATES = {"unverified", "recent", "stale", "clock_ahead", "lagging", "stopped"}
...
class SessionAssessment:
    ...
    def __post_init__(self):
        ...
        _choice(self.feed, "feed state", FEED_STATES)
...
def assess_session(raw_observation=None, collector_observation=None, *,
                   ...
                   lease="unverified", research="unverified"):
    ...
    bounded log-tail output of observe_collector(). Missing evidence stays
    unverified; this function performs no process scan, window scan, lease probe,
